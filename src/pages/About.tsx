    ...
    return (
        <MainLayout>
            <section className="mt-8 px-4">
                ...
                <h3 className="text-3xl text-[#344697] font-bold m-12 text-center">Les avantages C&C Com' Conseil : la mise à disposition d'une plateforme collaborative aux clients</h3>
                ...
                <div>
                    <p className="text-3xl text-[#344697] font-bold m-12 text-center">L'équipe C&C Com' Conseil</p>
                    <div className="flex flex-col md:flex-row justify-evenly items-center m-8">
                        <div className='flex flex-col items-center bg-blue-100 text-center text-blue-800 p-6 rounded-lg shadow-md mb-8 md:mb-0'>
